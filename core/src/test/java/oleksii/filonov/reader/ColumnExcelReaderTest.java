...
public class ColumnExcelReaderTest {
	...
	public void readFromCompaign() throws FileNotFoundException, IOException, InvalidFormatException {
		...
		final String[] firstVins = columnExcelReader.getUniqueColumnValues(seconSheet, VIN_MARKER);
		...
		final String[] lastVins = columnExcelReader.getUniqueColumnValues(lastSheet, VIN_MARKER);
